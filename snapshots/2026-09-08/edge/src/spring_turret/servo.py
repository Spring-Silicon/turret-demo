...
class ServoController:
    ...
    def _tick_locked(self) -> None:
        self._poll_locked()
        # Start persists independently of browser timers or connectivity.
        # Validate BOTH axes before any corrective motion; Stop, faults and
        # service shutdown still disarm. The physical bus watchdog is unchanged.
