"""Pinned full1008 native-v18 build from Israel's tracking hillclimb.
...
MANIFEST_SHA = '372cc3b84cc0bf664f38c5f9ad3c01237c7e2067af9ecba1f7fa238b72c4fa9a'
...
def verify_bundle(bundle, checkpoint):
    ...
    if str(bundle / 'source') != manifest['deployment_source_root']:
        raise ValueError('V18 receipt paths require the pinned deployment directory')
...
def initialize(engine, args, bundle, progress):
    ...
    config = json.loads((root / 'results/tracking_implementation_20260909/native_config_v18.json').read_text())
    ...
    engine.receipt = {
        'image_backend': 'israel-full1008-native-v18-temporal',
